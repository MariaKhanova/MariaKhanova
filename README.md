...
<h2>
  ...
  * Управленческий опыт - прошла путь от линейного сотрудника до директора в розничной сети, что дало понимание бизнес процессов, ответственности и работе с людьми.
  * Операционная экспертиза - многолетняя работа в сфере ощепита (повар, су-шеф) приучила к четким алгоритмам, многозадачности и соблюдению стандартов.
  * Дисциплина и целеустремленность - участие в 2 марафонах(10 км и 21 км), регулярные занятия спортом и йогой.
  * Саморазвитие и кругозор - увлечение русской класикой, осознаное питание и забота о себе, а также постоянное обучение.
...
* [Statistical-tests](https://github.com/MariaKhanova/Statistical-tests.git) - Представленны два проекта по теме Статистические тесты
* [Оценки отелей на Booking.com](https://github.com/MariaKhanova/Project-3.-Booking.com.git) - Создание первой модели, основанной на алгоритмах машинного обучения; участие в соревновании на Kaggle;
